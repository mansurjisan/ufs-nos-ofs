...
rm -f /lfs/h1/nos/ptmp/machuan.peng/rpt/v3.7.0/secofs_*_06.out
rm -f /lfs/h1/nos/ptmp/machuan.peng/rpt/v3.7.0/secofs_*_06.err
export LSFDIR=/lfs/h1/nos/nosofs/noscrub/machuan.peng/packages/nosofs.v3.7.0/pbs 
PREP=$(qsub  $LSFDIR/jnos_secofs_prep_06.pbs) 
NFRUN=$(qsub -W depend=afterok:$PREP $LSFDIR/jnos_secofs_nowcst_fcst_06.pbs)
qsub -W depend=afterok:$NFRUN $LSFDIR/jnos_secofs_aws_06.pbs
